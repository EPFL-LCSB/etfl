...
# -*- coding: utf-8 -*-
#
# etfl documentation build configuration file
...
latex_documents = [
    (master_doc, 'etfl.tex', 'ETFL Documentation',
     'ETFL Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'etfl', 'ETFL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'etfl', 'ETFL Documentation',
     author, 'ETFL', 'One line description of project.',
     'Miscellaneous'),
]
